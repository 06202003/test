        ...
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
            <div className="lg:col-span-2 lg:py-12">
              <h1 className="text-6xl">Aspiration Form</h1>
              <p className="max-w-xl text-lg pt-5 text-justify">
                Aspiration form adalah sebuah formulir yang digunakan untuk merekam dan mengumpulkan aspirasi atau harapan dari mahasiswa fakultas tekonologi informasi. Formulir ini digunakan untuk sarana untuk menyampaikan aspirasi dan
                harapan mahasiswa terkait kebijakan atau program kegiatan yang diadakan di lingkungan Fakultas Teknologi Informasi Maranatha, serta sebagai sarana untuk memberikan masukan tentang program dan kegiatan yang telah berlangsung.
              </p>
            ...
            <div className="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
              <form action="" className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div>
                    <label htmlFor="division" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white sr-only">
                      To Division
                    </label>
